...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       var imagen: ImageView = findViewById(R.id.imageView3)
        when(menuOption){
            "coldDrinks"->{
                imagen.setImageResource(R.drawable.colddrinks)
            }
            "hotDrinks"->{
                imagen.setImageResource(R.drawable.hotdrinks)
            }
            "sweets"->{
                imagen.setImageResource(R.drawable.sweets)
            }
            "salties"->{
                imagen.setImageResource(R.drawable.salties)
            }
            "Combos"->{
                imagen.setImageResource(R.drawable.colddrinks)
            }
